...
The histogram of the sample means shows that they are centered around the theoretical mean of `r 1/lambda` (The mean of origin exponential distribution). 
...
Theoretically, the standard deviation of sample means is $(1/\lambda)/\sqrt{n} = 1/0.2/\sqrt{40}$ = `r 1/0.2/sqrt(40)`, the variance is `r 1/(0.2^2)/40`. 

And the variance of sample means we obtained is `r var(sample_mean)`.
